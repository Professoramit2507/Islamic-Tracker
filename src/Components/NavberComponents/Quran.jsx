...
const Spiritual = () => {
  ...
  // ট্যাব ১: দৈনন্দিন ৪টি জীবন রক্ষাকারী মাসনুন দোয়া
  const duasData = [
    {
      id: 1,
      title: "বিপদ-আপদ থেকে সুরক্ষার সর্বশ্রেষ্ঠ দোয়া",
      arabic:
        "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ",
      bangla:
        "বিসমিল্লাহিল্লাজি লা ইয়াদুররু মা'আসমিহি شাইউন ফিল আরদি ওয়া লা ফিস সামায়ি, ওয়া হুওয়াস সামিউল আলিম।",
      meaning:
        "আল্লাহর নামে, যাঁর নামের বরকতে আসমান ও জমিনের কোনো কিছুই কোনো ক্ষতি করতে পারে না। আর তিনি সর্বশ্রোতা, সর্বজ্ঞ।",
      reward:
        "রাসুলুল্লাহ (সা.) বলেছেন, যে ব্যক্তি সকাল-সন্ধ্যায় ৩ বার এই দোয়া পড়বে, কোনো হঠাৎ বিপদে সে আক্রান্ত হবে না এবং কোনো কিছুই তার ক্ষতি করতে পারবে না।",
    },
    {
      id: 2,
      title: "দুশ্চিন্তা ও ঋণমুক্তি লাভের বিশেষ দোয়া",
      arabic:
        "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْهَمِّ وَالْحَزَنِ، وَأَعُوذُ بِكَ مِنَ الْعَجْزِ وَالْكَسَلِ، وَأَعُوذُ بِكَ مِنَ الْجُبْنِ وَالْبُخْلِ، وَأَعُوذُ بِكَ مِنْ غَلَبَةِ الدَّيْنِ وَقَهْرِ الرِّجَالِ",
      bangla:
        "আল্লাহুম্মা ইন্নি আউজু বিকা মিনাল হাম্মি ওয়াল হাজানি, ওয়া আউজু বিকা মিনাল আজজি ওয়াল কাসালি, ওয়া আউজু বিকা মিনাল জুবনি ওয়াল বুখলি, ওয়া আউজু বিকা মিন গালাবাতিদ দাইনি ওয়া কাহরির রিজাল।",
      meaning:
        "হে আল্লাহ! আমি আপনার আশ্রয় নিচ্ছি দুশ্চিন্তা ও দুঃখ-কষ্ট থেকে, অক্ষমতা ও অলসতা থেকে, কাপুরুষতা ও কৃপণতা থেকে এবং ঋণের বোঝা ও মানুষের অত্যাচার থেকে।",
      reward:
        "নিয়মিত সকালে ও সন্ধ্যায় এই দোয়াটি পাঠ করলে মনের যাবতীয় গোপন দুশ্চিন্তা দূর হয় এবং অলৌকিকভাবে ঋণ পরিশোধের ব্যবস্থা হয়ে যায়।",
    },
    {
      id: 3,
      title: "জাহান্নাম থেকে মুক্তির আকুল আবেদন",
      ...
      meaning: "হে আল্লাহ! আমাকে জাহান্নামের আগুন থেকে রক্ষা করুন।",
      reward:
        "ফজর ও মাগরিবের নামাজের পর কারও সাথে কথা না বলে এই দোয়াটি ৭ বার পাঠ করলে, ওই দিন বা রাতে মৃত্যু হলে আল্লাহ তাকে নিশ্চিত জাহান্নাম থেকে মুক্তি দেবেন।",
    },
    {
      id: 4,
      title: "রিজিকে বরকত ও পবিত্র জীবনের দোয়া",
      arabic:
        "اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلًا",
      bangla:
        "আল্লাহুম্মা ইন্নি আসআলুকা ইলমান নাফিয়া, ওয়া রিজকান তাইয়্যিবা, ওয়া আমালান মুতাকাব্বিলা।",
      meaning:
        "হে আল্লাহ! আমি আপনার কাছে উপকারী জ্ঞান, পবিত্র রিযিক এবং কবুলযোগ্য আমল প্রার্থনা করছি।",
      reward:
        "নবীজী (সা.) প্রতিদিন ফজরের নামাজের সালাম ফিরিয়েই এই বিশেষ দোয়াটি পাঠ করতেন, যা সারাদিনের কাজে বরকত এনে দেয়।",
    },
  ];
  ...
  const healingPoints = [
    ...
    {
      id: "৭",
      text: "যখনই মন খারাপ হবে, বেশি বেশি 'ইয়া হাইয়্যু ইয়া কাইয়্যুমু বিরাহমাতিকা আস্তাগিস' দোয়াটি পাঠ করুন।",
    },
    {
      id: "২",
      text: "অতিরিক্ত দুশ্চিন্তা ও হতাশা দূর করতে রাসুলুল্লাহ (সা.) সর্বদা সাইয়্যিদুল ইস্তিগফার পড়ার নির্দেশ দিয়েছেন।",
    },
    {
      id: "৮",
      text: "কারো ওপর ক্ষোভ বা রাগ জমা রাখবেন না; ক্ষমা করে দিলে আল্লাহ আপনার নিজের সম্মান ও মর্যাদা বহুগুণ বাড়িয়ে দেবেন।",
    },
    {
      id: "৩",
      text: "মনকে হিংসা, অহংকার এবং রিয়া (লোকদেখানো ইবাদত) থেকে মুক্ত রাখাই আধ্যাত্মিক উন্নতির প্রথম ধাপ।",
    },
    {
      id: "৯",
      text: "পাঁচ ওয়াক্ত ফরজ নামাজ ঠিক সময়ে একাগ্রতার সাথে আদায় করা মানসিক অবসাদ দূর করার সবচেয়ে বড় থেরাপি।",
    },
    {
      id: "৪",
      text: "যা হারিয়ে গেছে তার জন্য আফসোস না করে, আল্লাহর ফয়সালার ওপর সন্তুষ্ট থাকাই হলো খাঁটি তাকওয়া।",
    },
    {
      id: "১০",
      text: "প্রতিদিন অন্তত ৫টি আয়াত অর্থসহ বুঝে পড়ার অভ্যাস করুন, এটি অন্তরের মরচে পড়া দূর করতে সাহায্য করে।",
    },
    {
      id: "৫",
      text: "অন্টারকে জীবিত রাখতে চাইলে একাকী বসে আল্লাহর ভয়ে চোখের পানি ফেলার অভ্যাস গড়ে তুলুন।",
    },
    {
      id: "১১",
      text: "অশ্লীল দৃষ্টি ও হারাম কথাবার্তা থেকে কান ও চোখকে বাঁচিয়ে রাখা অন্তরের নূর বা আলো ধরে রাখার মূল চাবিকাঠি।",
    },
    {
      id: "৬",
      text: "দুনিয়ার মোহে অন্ধ না হয়ে পরকালের স্থায়ী জীবনের কথা চিন্তা করলে মন থেকে লোভ ও হিংসা দূর হয়ে যায়।",
    },
    {
      id: "১২",
      text: "সব সময় ওজু অবস্থায় থাকার চেষ্টা করুন; ওজু মানুষের ভেতরের রাগ ও শয়তানের কুপ্ররোচনাকে শান্ত করে।",
    },
  ];
  ...
  const nightSteps = [
    {
      step: "১",
      title: "ঘুমানোর পূর্বের সুন্নাহ আমল",
      desc: "বিছানা ঝেড়ে নেওয়া, ওজু অবস্থায় শোয়া, আয়াতুল কুরসি এবং সূরা ইখলাস, ফালাক, নাস পড়ে দুই হাতে ফুঁ দিয়ে পুরো শরীরে হাত বুলানো।",
    },
    {
      step: "২",
      title: "তাহাজ্জুদের শেষ রাতের শেষ প্রহর",
      desc: "রাতের শেষ তৃতীয়াংশে আল্লাহ প্রথম আসমানে নেমে আসেন এবং ডাকতে থাকেন—কে আছ ক্ষমাপ্রার্থী? আমি তাকে ক্ষমা করব। এই সময় ঘুম ভেঙে ওঠা অত্যন্ত বরকতময়।",
    },
    {
      step: "৩",
      title: "২ রাকাত সালাত",
      desc: "নূন্যতম ২ রাকাত বা ইচ্ছা অনুযায়ী সর্বোচ্চ ১২ রাকাত পর্যন্ত লম্বা রুকু ও সেজদার মাধ্যমে তাহাজ্জুদের নফল নামাজ আদায় করা।",
    },
    {
      step: "৪",
      title: "রোনাজারি ও দীর্ঘ মোনাজাত",
      desc: "নামাজ শেষ করে সেহরি বা ফজরের আগ পর্যন্ত সিজদায় গিয়ে নিজের পাপের জন্য কাঁদাকাটি করা এবং দুনিয়া ও আখেরাতের জন্য আল্লাহর কাছে আকুল আবেদন করা।",
    },
  ];
    ...
    <div className="min-h-screen bg-[#faf7f2] text-slate-800 font-sans pb-16">
      ...
      <div className="relative bg-linear-to-b from-slate-950 via-purple-950 to-slate-900 text-white pt-6 pb-24 px-6 rounded-b-[2.5rem] shadow-lg border-b border-purple-900/20">
        ...
        <div className="max-w-2xl mx-auto text-center mt-6 space-y-2">
          ...
          <h1 className="text-3xl md:text-4xl font-serif font-bold text-purple-50">
            আধ্যাত্মিকতা ও দৈনন্দিন দোয়া
          </h1>
          <p className="text-purple-200/70 text-xs md:text-sm">
            দৈনন্দিন মাসনুন দোয়া, মানসিক প্রশান্তি ও শেষ রাতের আমল গাইড
          </p>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-8">
        ...
        >
          ...
          <div className="flex items-center gap-4 text-center sm:text-left flex-col sm:flex-row">
            ...
            <div className="space-y-1">
              <div className="inline-flex items-center gap-1 bg-purple-950/5 border border-purple-900/10 px-2.5 py-0.5 rounded-full text-[10px] font-bold text-purple-950 tracking-wide">
                <Sparkles className="w-3 h-3 text-purple-600 animate-pulse" /> তিলাওয়াত মডিউল
              </div>
              <h3 className="text-lg font-serif font-black text-slate-800 tracking-tight">
          ...
          <div className="w-full sm:w-auto shrink-0">
            ...
            >
             <Link to="/read_quran">
               <span>কুরআন পড়তে ক্লিক করুন</span>
             </Link>
            </motion.button>
          </div>
        </motion.div>
      ...
      {/* user এর জন্য কুরআন শিক্ষা ও শেখার বিশেষ সেকশন */}
      <div className="max-w-4xl mx-auto px-6 mt-6">
        <div className="bg-gradient-to-r from-purple-900 via-purple-950 to-slate-900 p-6 rounded-3xl text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 border border-purple-800/40">
          <div className="flex items-center gap-4 text-center md:text-left flex-col md:flex-row">
            <div className="p-4 bg-white/10 rounded-2xl backdrop-blur-md border border-white/20 text-purple-200">
              <GraduationCap className="w-8 h-8" />
            </div>
            <div className="space-y-1">
              <span className="text-xs font-semibold uppercase tracking-widest text-purple-300">বিশেষ লার্নিং কর্নার</span>
              <h2 className="text-2xl font-serif font-bold text-white">
                 আজই শুরু করো কুরআন শিক্ষা!
              </h2>
              <p className="text-purple-200/80 text-xs md:text-sm max-w-md">
                সহজে আরবি উচ্চারণ, তাজবীদ এবং অর্থসহ কুরআন শেখার চমৎকার জার্নি শুরু হোক তোমার সাথেই।
              </p>
            </div>
          </div>
          <div className="shrink-0 w-full md:w-auto">
            <Link to="/learn-quran">
              <button className="w-full md:w-auto bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold px-6 py-3 rounded-xl text-xs md:text-sm shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2">
                <Award className="w-4 h-4" /> কুরআন শেখা শুরু করো
              </button>
            </Link>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-6 mt-8 relative z-20">
        ...
        {/* ট্যাব ২: ১২টি আত্মশুদ্ধি ও মানসিক শান্তির পয়েন্ট */}
        {activeTab === "healing" && (
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {activeTab === "night" && (
          ...
          >
            <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
              <BookOpen className="w-5 h-5 text-purple-900" />
              <h2 className="text-xl font-bold font-serif text-slate-800">
                তাহাজ্জুদ ও নৈশকালীন আমলের নিয়মাবলী
              </h2>
            </div>
            <div className="relative border-l-2 border-dashed border-purple-200 pl-6 ml-4 space-y-6">
              {nightSteps.map((step, index) => (
