...
const Halal_Food = () => {
  ...
  const eNumbersData = [
    ...
    { code: "E441", name: "Gelatin", status: "সন্দেহজনক", type: "ঘনত্ব বৃদ্ধিকারী", desc: "যদি উদ্ভিজ্জ (Plant-sourced) না হয়, তবে এটি ও-ইসলামী পদ্ধতিতে জবাই করা পশুর হাড় ও চামড়া থেকে তৈরি বা ক্ষতিকর উৎস থেকে হতে পারে।" },
    ...
    { code: "E100", name: "Curcumin", status: "হালাল", type: "হলుడు রং", desc: "এটি সম্পূর্ণ প্রাকৃতিকভাবে হলুদ গাছ থেকে নিষ্কাশন করা হয়। ব্যবহার করা সম্পূর্ণ নিরাপদ।" },
