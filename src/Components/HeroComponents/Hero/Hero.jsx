      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-16 w-full">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-black text-teal-950 leading-[1.15] tracking-tight">
            Build Your <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-700 to-emerald-600 relative">
              Islamic Routine
            </span>
            <br />
            Every Single Day
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start items-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto border border-slate-950/10 bg-white/60 
              text-slate-700 px-8 py-3.5 rounded-2xl font-bold transition flex 
          ...
          <div className="mt-12 pt-8 border-t border-slate-950/5 flex gap-6 md:gap-10 justify-center md:justify-start text-xs font-semibold uppercase tracking-wider text-slate-400">
            ...
            <div className="space-y-1">
              <p className="text-2xl font-black font-sans text-teal-950 tracking-tight 
              flex items-center gap-1.5 justify-center md:justify-start">
                <CheckCircle2 className="w-4 h-4 text-emerald-500 stroke-3" /> 100%
              </p>
              <p>Halal Tracking</p>
            </div>
            <div className="space-y-1">
              <p className="text-2xl font-black font-sans text-teal-950 tracking-tight flex 
              items-center gap-1.5 justify-center md:justify-start">
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 relative h-80 sm:h-112.5 lg:h-130 rounded-[36px] overflow-hidden order-1 md:order-2 border border-slate-950/5 p-2 bg-white shadow-xl shadow-slate-950/5"
        >
          ...
          <div className="w-full h-full rounded-[28px] overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-teal-950/20 
            ...
            <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex gap-1.5 z-20 bg-slate-950/20 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10">
              {images.map((_, index) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${index === currentIndex ? "w-4 bg-teal-400" : "w-1.5 bg-white/50 hover:bg-white"
                    }`}
                />
              ))}
            </div>
